...
* Matrix factorization ([ℹ️](https://github.com/misk-data-science/misk-dl/tree/master/materials/07-recommender-collaborative-filtering))
* Clustering
* Deep learning
...
[Fast.ai](https://www.fast.ai/) povides some fantastic virtual training that is worth exploring. Two videos you should watch now include:
