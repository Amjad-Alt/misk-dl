...
the skills you learned recently (i.e. embeddings, LSTM, functional keras API). The
...
1. Save your final preprocessing tokenizer to the `misk_dl/materials/09-project`
directory.
```{r, eval=FALSE}
save_text_tokenizer(tokenizer, "tokenizer-question-pairs")
```

2. Save your final model to the `misk_dl/materials/09-project` directory.
```{r, eval=FALSE}
...
`misk_dl/materials/09-project` directory.
